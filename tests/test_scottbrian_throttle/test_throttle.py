...
class RequestValidator:
    ...
    def validate_series(self,
        ...
        Args:
            about_to_send_time: list of times before each request send
            after_send_time: list of times after each request send
